...
void Rules::printAll()
{
  std::cout << "\tStart Cash:\t\t" << currencySymbol << startCash*exchangeRate;
  std::cout << "\n\tProperties are" << (dealProperties?"":" not") << " dealt at start.";
  std::cout << "\n\tSalary:\t\t\t" << currencySymbol << salary*exchangeRate;
  std::cout << "\n\tSalary is" << (doubleIfLandOnGo?"":" not") << " doubled when Go is landed upon.";
  std::cout << "\n\tNegative chance cards are" << (onlyNiceChance?"":" not") << " removed.";
  std::cout << "\n\tNegative community chest cards are" << (onlyNiceCommunity?"":" not") << " removed.";
  std::cout << "\n\tPositive chance cards are" << (onlyMeanChance?"":" not") << " removed.";
  std::cout << "\n\tPositive community chest cards are" << (onlyMeanCommunity?"":" not") << " removed.";
